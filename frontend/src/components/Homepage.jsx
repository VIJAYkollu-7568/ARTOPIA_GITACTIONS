        ...
        <div className="popup-overlay">
          <div className="popup-card">
            ...
            <div className="btn-row">
              <button className="login-btn" onClick={() => { setShowSignup(false); setShowLogin(true); }}>Login</button>
              <button className="login-btn signup-btn"
                onClick={() => { if (validateSignup()) alert("Signup submitted!"); }}>
                Signup
              </button>
            </div>
        ...
        <div className="popup-overlay">
          <div className="popup-card">
            ...
            <select value={loginType} onChange={(e) => setLoginType(e.target.value)}>
              <option value="" disabled>Login Type</option>
